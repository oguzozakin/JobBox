    ...
    public partial class MyFirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverLetter = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    LevelOfEducation = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeerPosition", x => new { x.EmployeerId, x.PositionId });
                    table.ForeignKey(
                        name: "FK_EmployeerPosition_Employeers_EmployeerId",
                        column: x => x.EmployeerId,
                        principalTable: "Employeers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeerPosition_Positions_PositionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeerWorkPlace", x => new { x.EmployeerId, x.WorkPlaceId });
                    table.ForeignKey(
                        name: "FK_EmployeerWorkPlace_Employeers_EmployeerId",
                        column: x => x.EmployeerId,
                        principalTable: "Employeers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeerWorkPlace_WorkPlace_WorkPlaceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeerPosition_PositionId",
                table: "EmployeerPosition",
                column: "PositionId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeerWorkPlace_WorkPlaceId",
                table: "EmployeerWorkPlace",
                column: "WorkPlaceId");
        }
